...
export class Challenge extends pulumi.CustomResource {
    ...
    constructor(name: string, args?: ChallengeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            resourceInputs["apiVersion"] = "acme.cert-manager.io/v1beta1";
...
export interface ChallengeArgs {
    apiVersion?: pulumi.Input<"acme.cert-manager.io/v1beta1">;
    kind?: pulumi.Input<"Challenge">;
    metadata?: pulumi.Input<ObjectMeta>;
    spec?: pulumi.Input<inputs.acme.v1beta1.ChallengeSpecArgs>;
    status?: pulumi.Input<inputs.acme.v1beta1.ChallengeStatusArgs>;
}
