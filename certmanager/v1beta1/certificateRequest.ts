...
export class CertificateRequest extends pulumi.CustomResource {
    ...
    constructor(name: string, args?: CertificateRequestArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            resourceInputs["apiVersion"] = "cert-manager.io/v1beta1";
...
export interface CertificateRequestArgs {
    apiVersion?: pulumi.Input<"cert-manager.io/v1beta1">;
    kind?: pulumi.Input<"CertificateRequest">;
    metadata?: pulumi.Input<ObjectMeta>;
    /**
     * Desired state of the CertificateRequest resource.
     */
    spec?: pulumi.Input<inputs.certmanager.v1beta1.CertificateRequestSpecArgs>;
    /**
     * Status of the CertificateRequest. This is set and managed automatically.
     */
    status?: pulumi.Input<inputs.certmanager.v1beta1.CertificateRequestStatusArgs>;
}
